...
typedef enum instrucoes_op {
  // Constantes
  nop = 0x00, aconst_null = 0x01, iconst_m1 = 0x02, iconst_0 = 0x03, iconst_1 = 0x04, iconst_2 = 0x05, iconst_3 = 0x06, iconst_4 = 0x07, iconst_5 = 0x08,
  lconst_0 = 0x09, lconst_1 = 0x0a, fconst_0 = 0x0b, fconst_1 = 0x0c, fconst_2 = 0x0d, dconst_0 = 0x0e, dconst_1 = 0x0f,
  ...
  idiv = 0x6c, inst_ldiv = 0x6d, fdiv = 0x6e, ddiv = 0x6f,
  irem = 0x70, lrem = 0x71,      frem = 0x72, inst_drem = 0x73,
  ineg = 0x74, lneg = 0x75,      fneg = 0x76, dneg = 0x77,

  // Operações lógicas e de deslocamento
  ishl = 0x78, lshl = 0x79, ishr = 0x7a, lshr = 0x7b, iushr = 0x7c, lushr = 0x7d, iand = 0x7e, 
  land = 0x7f, ior  = 0x80, lor  = 0x81, ixor  = 0x82, lxor  = 0x83, iinc = 0x84,
  ...
  // Controle de fluxo
  inst_goto = 0xa7, jsr = 0xa8, ret = 0xa9, tableswitch = 0xaa, lookupswitch = 0xab,

  // Retornos
  ireturn = 0xac, lreturn = 0xad, freturn = 0xae, dreturn = 0xaf, areturn = 0xb0, inst_return = 0xb1,
  ...
  inst_new = 0xbb, newarray = 0xbd, anewarray = 0xbe, arraylength = 0xbf, athrow = 0xc0, checkcast = 0xc1, instanceof = 0xc2,
  monitorenter = 0xc3, monitorexit = 0xc4,
